/*
  ...
  - Made the column `boardId` on table `Frame` required. This step will fail if there are existing NULL values in that column.
  - Made the column `boardId` on table `Screenshot` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_Frame" ("boardId", "createdAt", "height", "id", "name", "userId", "width", "x", "y") SELECT "boardId", "createdAt", "height", "id", "name", "userId", "width", "x", "y" FROM "Frame";
DROP TABLE "Frame";
...
INSERT INTO "new_Screenshot" ("boardId", "boardScale", "boardX", "boardY", "capturedAt", "createdAt", "height", "id", "mimeType", "pageTitle", "sourceUrl", "storageKey", "userId", "width") SELECT "boardId", "boardScale", "boardX", "boardY", "capturedAt", "createdAt", "height", "id", "mimeType", "pageTitle", "sourceUrl", "storageKey", "userId", "width" FROM "Screenshot";
